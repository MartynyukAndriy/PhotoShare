...
from src.database.models import Image, User, Tag, Rating, image_m2m_tag
from src.database.db import get_db


def find_image_by_tag(skip: int, limit: int, search: str, filter_type: int, db: Session, user: User):
    if search:
